...
{#if keyboard.helpVisible}
	...
	<div
		...
		<div
			class="bg-base-100 rounded-lg shadow-xl max-w-lg w-full mx-4 p-6"
			role="dialog"
			...
			<div class="mt-6 pt-4 border-t border-base-300">
				<p class="text-sm text-base-content/60">
					Hover over a card and use <kbd class="kbd kbd-xs">Alt+N</kbd> to add or
					<kbd class="kbd kbd-xs">Alt+Shift+N</kbd> to remove, where N is the treatment number shown on
					the card.
				</p>
			</div>
		</div>
